              ...
              >
                ...
                {c.imageUrl && (
                  <div className="absolute inset-0 z-0 pointer-events-none">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-surface/95 via-surface/60 sm:via-surface/50 to-transparent" />
                    <div className="absolute inset-0 bg-gradient-to-t from-surface via-surface/40 sm:via-surface/20 to-transparent" />
                  </div>
                )}
