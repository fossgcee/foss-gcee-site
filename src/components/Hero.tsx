...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ── Two-column layout ────────────────────────────── */}
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-10 lg:px-12 xl:px-16 w-full py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-6 lg:gap-8 items-center">
